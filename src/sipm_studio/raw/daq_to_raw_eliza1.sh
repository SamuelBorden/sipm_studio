...
singularity exec --bind /data/eliza1/LEGEND/data/LNsipm:/data/eliza1/LEGEND/data/LNsipm /data/eliza1/LEGEND/sw/containers/legend-base.sif /home/$USER/sipm_studio/raw/submit_daq_to_raw.sh
