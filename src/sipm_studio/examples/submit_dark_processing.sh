...
#$ -N mp_dark_calculation                   #job name
...
singularity exec --bind /data/eliza1/LEGEND/:/data/eliza1/LEGEND/,/home/$USER:/home/$USER /data/eliza1/LEGEND/sw/containers/legend-base.sif python3 /home/$USER/sipm_studio/sipm_studio/src/flow/process_job.py -i "/home/$USER/sipm_studio/sipm_studio/src/examples/process_dark.json" -c ${NSLOTS} -s "dark"
