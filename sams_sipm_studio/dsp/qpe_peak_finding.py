...
def guess_peaks(n: np.array, bins: np.array, min_height: float, min_dist: float, min_width: float) -> tuple(np.array, np.array, np.array):
    """
...
def guess_peaks_no_width(n: np.array, bins: np.array, min_height: float, min_dist: float) -> tuple(np.array, np.array, np.array):
    """
...
def fit_peaks(n: np.array, bins: np.array, peaks: np.array, peak_locs: np.array, amplitudes: np.array, fit_width: float = 15) -> tuple(np.array, np.array):
    """
...
def fit_peak(n: np.array, bins: np.array, peaks: np.array, peak_locs: np.array, amplitudes: np.array, fit_width: float = 15) -> tuple(np.array, np.array):
    """
