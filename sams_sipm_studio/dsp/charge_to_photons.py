...
def apd_photons(charge: np.array, charge_err: np.array, photosensitivity: float = 24, l: float = 560) -> float:
    """
...
def apd_charge_photons(light_charge: np.array, light_charge_err: np.array, dark_charge: np.array, dark_charge_err: np.array) -> float:
    """
