...
def rando_integrate_current(current_forms: np.array, width: int, sample_time: float=2e-9) -> np.array:
    """
...
def integrate_current(current_forms: np.array, lower_bound: int = 0, upper_bound: int = 200, sample_time: float = 2e-9) -> np.array:
    """
